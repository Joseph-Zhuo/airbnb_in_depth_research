...
Besides status analysis, we are more curious about the development of Airbnb houses in New York within the past 13 years. We plot the number of new hosted Airbnb properties by year to observe the growth.
...
1. From 2008 to 2015, the increment number was increasing, especially in Brooklyn and Manhattan. This shows that Airbnb was growing radially in these years. From 2016 to 2019, the increment number had a sign to go down and remained stable after 2017. Nevertheless, in 2020, the increment decreased rapidly and even there was no increment number in Staten Island, no doubt which was the consequence of Covid-19.
...
It is also worth mention that most reviews that we visualize in this research are from either from Manhattan or Brooklyn as it is shown in the treemap
...
As ew can see from the mosaic plot, more expensive properties tend to have slightly more excellent reviews and less poor reviews. However, we do not think the relationship is very significant. Furthermore, we can observe that most listings on Airbnb have reasonable prices(below XXX above XXX) and their review scores are all good( from 92 - 100).
